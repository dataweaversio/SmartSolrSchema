...
$solution = "$scriptRoot\..\SmartSolrSchema.sln"

& $nuGet restore $solution
& $msBuild $solution /p:Configuration=Release /t:Rebuild /m

& dotnet pack "$scriptRoot\..\src\SmartSolrSchema\SmartSolrSchema.csproj" -Property:Configuration=Release -o $scriptRoot --include-symbols