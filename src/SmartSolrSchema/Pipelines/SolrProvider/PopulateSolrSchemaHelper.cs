...
namespace SmartSolrSchema.Pipelines.SolrProvider
{
    public class PopulateSolrSchemaHelper : ISchemaPopulateHelper
    {
        ...
        private IEnumerable<XElement> GetAddFields()
        {
            ...
            yield return CreateField("*_tdts", "pdate", required: false, indexed: true, stored: false, multiValued: false, omitNorms: false, termVectors: false, termPositions: false, termOffsets: false, null, isDynamic: true);
